...
using StudentAchievementTests;
using Color = Avalonia.Media.Color;

namespace UITestsForAchievnetTests
{
    public class UnitTests
    {
        ...
        public async void color_tests_yellow()
        {
            ...
            var visualProgrammBorder = grid.GetVisualDescendants().OfType<Border>().First(x => (x.Name != null) && x.Name.Equals("a1"));
